const english = {
  ...
  insight: {
    title: "Insight",
    heading: "JobFit Insight",
    introduction:
      "JobFit Insight help you analyze detail about the recruitment position, about the distribution of skills among candidates' scores.",
